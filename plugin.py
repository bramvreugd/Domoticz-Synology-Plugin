"""
<plugin key="SynoMonitor" name="Synology Monitor" author="bramvreugd, febalci" version="2.0">
    <description>
        <h2>    </h2><br/>
        Collects CPU, Memory, Heat, HDD Information and network load from Synology NAS Units<br/>
        <br/>
...
from pysnmp.entity.rfc3413.oneliner import cmdgen  #.entity.rfc3413.oneliner
# v2.0.0:   Network load added.
...
class BasePlugin:
    ...
    def __init__(self):
        ...
        self.snmpBondIn = '.1.3.6.1.2.1.31.1.1.1.6.6'
        self.snmpBondOut = '.1.3.6.1.2.1.31.1.1.1.10.6'
        self.ups = False
        self.bondIn =0
        self.bondOut=0
        return
...
#        iconPID = Images["Life360Presence"].ID
        ...
        if (len(Devices) <15):   
            Domoticz.Device(Name=self.synoModel+' Network upload', Unit=14, TypeName="Custom", Options={"Custom": "1000;kb/s"},Used=0).Create()
            Domoticz.Device(Name=self.synoModel+' Network download', Unit=15, TypeName="Custom", Options={"Custom": "1000;kb/s"},Used=0).Create()
